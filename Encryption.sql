drop database if exists EAEA;
create database EAEA;
use EAEA;
...
alter table countries modify Continent varbinary(80);
alter table countries modify Region varbinary(80);
alter table countries modify SurfaceArea varbinary(80);
alter table countries modify Population varbinary(80);
alter table countries modify LifeExpectancy varbinary(80);
alter table countries modify GNP varbinary(80);
alter table countries modify LocalName varbinary(80);
alter table countries modify GovernmentForm varbinary(80);
alter table countries modify HeadOfState varbinary(80);
alter table countries modify budget varbinary(80);
alter table countries modify x varbinary(80);
alter table countries modify y varbinary(80);

update countries
set Continent = aes_encrypt(cast(Continent as char),'iaea'),
Region = aes_encrypt(cast(Region as char),'iaea'),
LifeExpectancy = aes_encrypt(cast(LifeExpectancy as char),'iaea'),
LocalName = aes_encrypt(cast(LocalName as char),'iaea'),
GovernmentForm = aes_encrypt(cast(GovernmentForm as char),'iaea'),
HeadOfState = aes_encrypt(cast(HeadOfState as char),'iaea');

alter table nuclear_plant_status modify plant_status_type varbinary(80);

update nuclear_plant_status
set plant_status_type = aes_encrypt(cast(plant_status_type as char),'iaea');

alter table nuclear_reactor_type modify reactor_type_type varbinary(80);
alter table nuclear_reactor_type modify reactor_type_description varbinary(80);

update nuclear_reactor_type
set reactor_type_type = aes_encrypt(cast(reactor_type_type as char),'iaea'),
reactor_type_description = aes_encrypt(cast(reactor_type_description as char),'iaea');

alter table nuclear_power_plants modify power_plants_latitude varbinary(80);
alter table nuclear_power_plants modify power_plants_longitude varbinary(80);
alter table nuclear_power_plants modify power_plants_reactor_model varbinary(80);
alter table nuclear_power_plants modify power_plants_construction_start_at varbinary(80);
alter table nuclear_power_plants modify power_plants_operational_from varbinary(80);
alter table nuclear_power_plants modify power_plants_operational_to varbinary(80);
alter table nuclear_power_plants modify power_plants_capacity varbinary(80);
alter table nuclear_power_plants modify power_plants_source varbinary(80);
alter table nuclear_power_plants modify power_plants_last_updated_at varbinary(80);

update nuclear_power_plants
set power_plants_reactor_model = aes_encrypt(cast(power_plants_reactor_model as char),'iaea'),
power_plants_construction_start_at = aes_encrypt(cast(power_plants_construction_start_at as char),'iaea'),
power_plants_operational_from = aes_encrypt(cast(power_plants_operational_from as char),'iaea'),
power_plants_operational_to = aes_encrypt(cast(power_plants_operational_to as char),'iaea'),
power_plants_source = aes_encrypt(cast(power_plants_source as char),'iaea'),
power_plants_last_updated_at = aes_encrypt(cast(power_plants_last_updated_at as char),'iaea');

alter table largest_production_centers modify production_centers_budget varbinary(80);
alter table largest_production_centers modify production_centers_establishment_date varbinary(80);
alter table largest_production_centers modify production_centers_founder varbinary(80);

update largest_production_centers
set production_centers_establishment_date = aes_encrypt(cast(production_centers_establishment_date as char),'iaea'),
production_centers_founder = aes_encrypt(cast(production_centers_founder as char),'iaea');

alter table weapons_types modify weapons_types_type varbinary(80);
alter table weapons_types modify weapons_types_cost varbinary(80);
alter table weapons_types modify weapons_types_action_range varbinary(80);
alter table weapons_types modify weapons_types_threat_level varbinary(80);

update weapons_types
set weapons_types_type = aes_encrypt(cast(weapons_types_type as char),'iaea'),
weapons_types_action_range = aes_encrypt(cast(weapons_types_action_range as char),'iaea'),
weapons_types_threat_level = aes_encrypt(cast(weapons_types_threat_level as char),'iaea');

alter table weapons_warehouse modify weapons_warehouse_quantity varbinary(80);
alter table military_conflicts modify military_conflicts_start_date varbinary(80);
alter table military_conflicts modify military_conflicts_end_date varbinary(80);
alter table military_conflicts modify military_conflicts_conflict_cause varbinary(80);

update military_conflicts
set military_conflicts_start_date = aes_encrypt(cast(military_conflicts_start_date as char),'iaea'),
military_conflicts_end_date = aes_encrypt(cast(military_conflicts_end_date as char),'iaea'),
military_conflicts_conflict_cause = aes_encrypt(cast(military_conflicts_conflict_cause as char),'iaea');

alter table fuel_enrichment modify fuel_enrichment_fuel_amount varbinary(80);
alter table fuel_enrichment modify fuel_enrichment_time_since_start varbinary(80);
alter table fuel_enrichment modify fuel_enrichment_fuel_type varbinary(80);

update fuel_enrichment
set fuel_enrichment_time_since_start = aes_encrypt(cast(fuel_enrichment_time_since_start as char),'iaea'),
fuel_enrichment_fuel_type = aes_encrypt(cast(fuel_enrichment_fuel_type as char),'iaea');

alter table enterprise_audit_results modify audit_results_audit_date varbinary(80);
alter table enterprise_audit_results modify audit_results_malfunctions_number varbinary(80);
alter table enterprise_audit_results modify audit_results_conclusion varbinary(80);

update enterprise_audit_results
set audit_results_audit_date = aes_encrypt(cast(audit_results_audit_date as char),'iaea'),
audit_results_conclusion = aes_encrypt(cast(audit_results_conclusion as char),'iaea');

alter table activities modify activities_start_time varbinary(80);
alter table activities modify activities_end_time varbinary(80);
alter table activities modify activities_subjects varbinary(80);
alter table activities modify activities_speaker varbinary(80);

update activities
set activities_start_time = aes_encrypt(cast(activities_start_time as char),'iaea'),
activities_end_time = aes_encrypt(cast(activities_end_time as char),'iaea'),
activities_subjects = aes_encrypt(cast(activities_subjects as char),'iaea'),
activities_speaker = aes_encrypt(cast(activities_speaker as char),'iaea');

alter table nuclear_waste modify nuclear_waste_volume varbinary(80);
alter table financial_countries_history modify history_order_date varbinary(80);
alter table investments_history modify investments_date varbinary(80);
alter table investments_history modify investments_value varbinary(80);
alter table tax_history modify tax_value varbinary(80);
alter table tax_history modify tax_date varbinary(80);
